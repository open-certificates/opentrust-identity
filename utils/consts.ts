...
export const ALL_INTERNAL_SCOPE_NAMES = [
    ...
    // Scope itself
    SCOPE_CREATE_SCOPE, SCOPE_UPDATE_SCOPE, SCOPE_DELETE_SCOPE, SCOPE_READ_SCOPE, SCOPE_TENANT_ASSIGN_SCOPE, SCOPE_TENANT_REMOVE_SCOPE, SCOPE_CLIENT_ASSIGN_SCOPE, SCOPE_CLIENT_REMOVE_SCOPE,
    // Signing Keys
...
export const DEFAULT_TENANT_BOUND_INTERNAL_SCOPE_NAMES = [
    ...
    CLIENT_CREATE_SCOPE, CLIENT_UPDATE_SCOPE, CLIENT_DELETE_SCOPE, CLIENT_READ_SCOPE,
    // Scope itself
    SCOPE_READ_SCOPE, SCOPE_CLIENT_ASSIGN_SCOPE, SCOPE_CLIENT_REMOVE_SCOPE,
    // Signing keys
    KEY_CREATE_SCOPE, KEY_DELETE_SCOPE, KEY_READ_SCOPE,
    // Rate limits
